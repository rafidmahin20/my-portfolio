  ...
  return (
    <section className="mb-20 text-gray-700">
      <div className="text-center md:max-w-xl lg:max-w-3xl mx-auto">
        ...
        <p className="mb-6 pb-2 md:mb-12 md:pb-0">Let's see what our clients say</p>
      </div>
          ...
          <div className="block rounded-lg shadow-lg bg-white">
            ...
            <div className="p-6">
              ...
              <p className="mt-4">
                ...
                He listens his clients demands very carefully.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="block rounded-lg shadow-lg bg-white">
            ...
            <div className="p-6">
              ...
              <p className="mt-4">
                ...
                He is a very passionate web developer.He done his tasks
                beautifully.
              </p>
            </div>
          </div>
          ...
          <div className="block rounded-lg shadow-lg bg-white">
            ...
            <div className="p-6">
              ...
              <p className="mt-4">
                ...
                Escellent developer very very good
              </p>
            </div>
          </div>
        </div>
